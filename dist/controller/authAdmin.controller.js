...
const authAdmin_shema_1 = require("./authAdmin.shema");
const jwt_1 = require("../utils/jwt");
const session_model_1 = __importDefault(require("../models/session.model"));
const appAssert_1 = __importDefault(require("../utils/appAssert"));
exports.registerHandler = (0, catchErrors_1.default)(async (req, res) => {
    const request = authAdmin_shema_1.registerSchema.parse({
        ...req.body,
...
exports.loginHandler = (0, catchErrors_1.default)(async (req, res) => {
    const request = authAdmin_shema_1.loginSchema.parse({
        ...req.body,
        userAgent: req.headers['user-agent'],
    });
...
exports.refreshHandler = (0, catchErrors_1.default)(async (req, res) => {
    ...
    const { accessToken, newRefreshToken } = await (0, authAdmin_service_1.refreshUserAccessToken)(refreshToken);
    if (refreshToken) {
...
exports.verifyEmailHandler = (0, catchErrors_1.default)(async (req, res) => {
    const { code } = zod_1.z
        ...
        .parse(req.params);
    await (0, authAdmin_service_1.verifyEmail)(code);
...
exports.sendPasswordResetHandler = (0, catchErrors_1.default)(async (req, res) => {
    const { email } = zod_1.z
        ...
        .parse(req.body);
    await (0, authAdmin_service_1.sendPasswordResetEmail)(email);
